# PaperPilot — Project Overview

PaperPilot is an advanced AI-powered platform designed for teachers to automate the evaluation of subjective student answers. It combines local OCR, Retrieval-Augmented Generation (RAG), and Large Language Models (LLMs) to provide fair, consistent, and explainable grading.
