# PaperPilot — Setup & Installation Guide

This guide provides a step-by-step walkthrough for setting up PaperPilot from scratch, including cloning, API configuration, and software dependencies like Tesseract OCR.
...
PaperPilot uses local Tesseract for OCR to ensure data privacy and zero cost.
...
5.  Give your key a name (e.g., `PaperPilot-Dev`).
